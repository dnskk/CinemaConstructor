...
namespace AdminPanel.Migrations
{
    ...
    [Migration("20200513201010_AddedFilmSession")]
    partial class AddedFilmSession
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdminPanel.Models.FilmSession", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AdminPanel.Models.FilmSession", b =>
                {
                    b.HasOne("AdminPanel.Models.Film", "Film")
                        .WithMany()
                        .HasForeignKey("FilmId");

                    b.HasOne("AdminPanel.Models.Hall", "Hall")
                        .WithMany()
